...
class TosModelAccepts extends TosModelBase 
{
    ...
    protected function _buildQueryWhere(&$query)
    {
    	...
    	$filter_terms_id    = $this->getState('filter_terms_id');
        ...
        if ($filter) 
        {
            ...
            $where = array();
            $where[] = 'LOWER(tbl.accept_id) LIKE '.$key;
            $where[] = 'LOWER(tbl.terms_id) LIKE '.$key;
